...
const MOCK_BOOKS: Book[] = [
  {
    ...
    updatedAt: BigInt(Math.floor(Date.now() / 1000) - 86400 * 30),
  },
  {
    id: 2n,
    isbn: "978-0061120084",
    ...
    availableCopies: 1n,
    active: true,
    createdAt: BigInt(Math.floor(Date.now() / 1000) - 86400 * 60),
    updatedAt: BigInt(Math.floor(Date.now() / 1000) - 86400 * 15),
  },
  {
    id: 3n,
    isbn: "978-0451524935",
    ...
    availableCopies: 0n, 
    active: true,
    createdAt: BigInt(Math.floor(Date.now() / 1000) - 86400 * 100),
    updatedAt: BigInt(Math.floor(Date.now() / 1000) - 86400 * 5),
  },
  {
    id: 4n,
    isbn: "978-0316769174",
    ...
    updatedAt: BigInt(Math.floor(Date.now() / 1000) - 86400 * 2),
  },
  {
    id: 5n,
    isbn: "978-0544003415",
    ...
    availableCopies: 4n,
    active: true,
    createdAt: BigInt(Math.floor(Date.now() / 1000) - 86400 * 200),
    updatedAt: BigInt(Math.floor(Date.now() / 1000) - 86400 * 20),
  }
];
