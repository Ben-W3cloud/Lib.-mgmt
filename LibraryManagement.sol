...
contract LibraryManagement {
    ...
    function addBook(
        ...
        emit BookAdded(bookId, title, author, isbn, copies, copies);
    }

    /**
     * @notice Increase copies for an existing book.
     */
    function addBookCopies(uint256 bookId, uint64 additionalCopies) external onlyOwner {
    ...
    /**
     * @notice Enable or disable borrowing for a specific book.
     */
